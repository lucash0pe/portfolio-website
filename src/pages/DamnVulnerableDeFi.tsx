  ...
  return (
    <>
      <SEOHead 
        ...
        description="Explore Damn Vulnerable DeFi challenges and solutions - a wargame to learn offensive security of DeFi smart contracts."
      />
        ...
        <div className="max-w-7xl mx-auto text-center space-y-6">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground font-light tracking-wide max-w-2xl mx-auto">
              Challenges and solutions for learning offensive security of DeFi smart contracts
            </p>
          </motion.div>
        </div>
      </section>
